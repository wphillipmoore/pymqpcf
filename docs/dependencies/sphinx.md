...
directive support used by the pymqpcf documentation. The `>=8.0`
constraint ensures compatibility with MyST-Parser 4.x and the `furo`
theme.

## Current constraint

`sphinx>=8.0` — added 2026-02-09 when Sphinx documentation was
introduced to the project.

## Failure history

- 2026-02-09: Sphinx 7.x not tested; constraint set proactively to
