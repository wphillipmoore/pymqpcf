...
the pymqpcf documentation. The `>=4.0` constraint ensures these
features are available.

## Current constraint

`myst-parser>=4.0` — added 2026-02-09 when Sphinx documentation was
introduced to the project.

## Failure history

- 2026-02-09: MyST-Parser 3.x not tested; constraint set proactively to
